...
output <- matrix(nrow=nrow(dataset), ncol=23, 0)
...
#BASE FULL
write.csv(full10t, "~/Desktop/PCA_WOODEN/NIR_Wooden_FULL10t.csv", row.names = F)

half12t <- cbind(output[c(1:20, 41:60),], targets[c(1:20, 41:60),])
write.csv(half12t, "~/Desktop/PCA_WOODEN/NIR_Wooden_HALF12t.csv", row.names = F)